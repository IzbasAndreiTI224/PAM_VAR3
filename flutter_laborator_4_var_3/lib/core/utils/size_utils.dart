...
// Add extension for nullable double
...
class SizeUtils {
  ...
  static double height = FIGMA_DESIGN_HEIGHT.toDouble(); // Initialize with default
  static double width = FIGMA_DESIGN_WIDTH.toDouble();   // Initialize with default
