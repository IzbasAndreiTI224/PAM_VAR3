...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      id: json['id'] ?? 0,
      brand: json['brand'] ?? '',
      name: json['name'] ?? '', // 👈 Lasă așa, se curăță în repository
      image: json['image'] ?? '',
...
class ProductDetail {
  ...
  factory ProductDetail.fromJson(Map<String, dynamic> json) {
    return ProductDetail(
      id: json['id'] ?? '',
      title: json['title'] ?? '', // 👈 Lasă așa, se curăță în repository
      brand: json['brand'] ?? '',
      description: json['description'] ?? '', // 👈 Lasă așa, se curăță în repository
